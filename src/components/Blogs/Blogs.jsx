				...
				<div class="main_featured m-top-100">
					<div class="col-sm-12">
						<div class=" text-center">
							...
							<p className='text-sm text-gray-600 p-4 ml-80 mr-80'>Crafting dynamic and user-friendly websites, delivering Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. mobile applications across platforms, and empowering individuals and teams with essential tech skills through expert-led training at BloomTechnosys. </p>
						</div>
					</div>
				</div>
			</div>
    ...
    <div className='flex px-20 gap-6 justify-center items-center mb-20'>
            <div className='border-2 border-gray-300 bg-gray-50'>
                ...
                <div className='px-5 py-10'>
                    <h2 className='text-md mb-5'>PLEASUARE WITHOUT CONSCIENCE</h2>
